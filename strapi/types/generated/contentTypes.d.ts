...
export interface ApiPageAboutPageAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    ambition: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    lieu_description: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    lieu_title: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    >;
    manifest_description: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    manifest_title: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    program_button: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    sur_place: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPagePartenairePagePartenaire
  extends Struct.SingleTypeSchema {
  collectionName: 'page_partenaires';
  info: {
    displayName: 'page-partenaire';
    pluralName: 'page-partenaires';
    singularName: 'page-partenaire';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    join_us: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    join_us_button: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    join_us_description: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::page-partenaire.page-partenaire'
    >;
    official_partners: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPartenerPartener extends Struct.CollectionTypeSchema {
  collectionName: 'parteners';
  info: {
    displayName: 'partener';
    pluralName: 'parteners';
    singularName: 'partener';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    partner_website_url: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
