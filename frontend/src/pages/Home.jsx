      ...
      <section className="relative h-screen w-full overflow-hidden">
        ...
        <div className="relative z-10 flex h-full flex-col items-center justify-center px-6 text-center">
          <div className="animate-fadeInUp">
            <SmallLabel>🎬 Marseille — Festival de courts-métrages IA</SmallLabel>
          </div>

          <h1 className="mt-8 max-w-5xl text-5xl font-black leading-[1.1] tracking-tight md:text-7xl lg:text-8xl animate-fadeInUp" style={{ animationDelay: '0.1s' }}>
            Raconter <span className="bg-gradient-to-r from-cyan-400 via-violet-400 to-fuchsia-400 bg-clip-text text-transparent">l'impossible</span>
            <br />
            <span className="text-white/80">en 60 secondes</span>
          </h1>

          <p className="mt-7 max-w-2xl text-base leading-8 text-white/85 md:text-lg animate-fadeInUp" style={{ animationDelay: '0.2s' }}>
            Le premier festival dédié aux courts-métrages créés par intelligence artificielle.
            <br className="hidden md:block" />
            Une nouvelle ère de la création cinématographique commence ici.
          </p>

          <div className="mt-10 flex flex-wrap justify-center gap-4 animate-fadeInUp" style={{ animationDelay: '0.3s' }}>
            <Link
              to="/participer"
          ...
          <div className="mt-12 grid w-full max-w-4xl grid-cols-1 gap-4 sm:grid-cols-3 animate-fadeInUp" style={{ animationDelay: '0.4s' }}>
            <div className="group rounded-2xl border border-cyan-400/20 bg-gradient-to-br from-cyan-500/10 to-violet-500/10 px-6 py-5 backdrop-blur-lg transition-all hover:border-cyan-400/40 hover:shadow-[0_0_20px_rgba(34,211,238,0.2)]">
              ...
              <div className="mt-1 text-sm font-semibold text-white/70">Format ultra-court</div>
            </div>
            <div className="group rounded-2xl border border-violet-400/20 bg-gradient-to-br from-violet-500/10 to-fuchsia-500/10 px-6 py-5 backdrop-blur-lg transition-all hover:border-violet-400/40 hover:shadow-[0_0_20px_rgba(139,92,246,0.2)]">
              ...
              <div className="mt-1 text-sm font-semibold text-white/70">Créé par IA</div>
            </div>
            <div className="group rounded-2xl border border-fuchsia-400/20 bg-gradient-to-br from-fuchsia-500/10 to-pink-500/10 px-6 py-5 backdrop-blur-lg transition-all hover:border-fuchsia-400/40 hover:shadow-[0_0_20px_rgba(217,70,239,0.2)]">
              ...
              <div className="mt-1 text-sm font-semibold text-white/70">Première édition</div>
            </div>
          </div>

          <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 animate-bounce">
            <div className="text-xs font-bold uppercase tracking-wider text-white/50">Découvrir</div>
