    ...
    <div className="relative w-full min-h-screen bg-[#020617] text-slate-200 py-20 px-6 font-sans overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <header className="relative text-center mb-24">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-32 bg-blue-500/20 blur-[80px] rounded-full pointer-events-none"></div>

          <div className="flex justify-center items-center mb-4 gap-4 relative z-10">
            <div className="h-[2px] w-12 bg-blue-500"></div>
            <span className="text-[15px] tracking-[0.5em] text-blue-400 uppercase font-bold">
              Protocoles Juridiques
            </span>
            <div className="h-[2px] w-12 bg-pink-500"></div>
          </div>
          
         <h1 className="relative z-10 text-5xl sm:text-6xl md:text-8xl font-black italic tracking-tighter bg-gradient-to-r from-blue-600 from-[35%] to-pink-500 to-[65%] bg-clip-text text-transparent inline-block 
               [paint-order:stroke_fill]
               [-webkit-text-stroke:1px_white] md:[-webkit-text-stroke:1px_white]
               drop-shadow-[0_0_15px_rgba(255,255,255,0.7)] 
               filter">
  MARS.AI
</h1>
          
          <p className="relative z-10 mt-6 text-white uppercase tracking-[0.3em] text-m md:text-sm">
            Conditions Générales d'Utilisation <span className="mx-2 text-white">//</span> 
        ...
        <div className="mt-24 text-center relative z-10">
          <p className="text-[20px] text-slate-600 uppercase tracking-[0.5em] mb-4 font-mono">
