      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <header className="relative text-center mb-24">
          ...
          <div className="flex justify-center items-center mb-4 gap-4 relative z-10">
            ...
            <div className="h-[2px] w-12 bg-pink-500/50"></div>
          </div>
          
          <h1 className="relative z-10 text-6xl md:text-8xl font-black italic tracking-tighter bg-gradient-to-r from-blue-400 from-[35%] to-pink-500 to-[65%] bg-clip-text text-transparent inline-block">
            MARS.AI
          </h1>
          
          <p className="relative z-10 mt-6 text-white uppercase tracking-[0.3em] text-m md:text-sm">
            Conditions Générales d'Utilisation <span className="mx-2 text-slate-700">//</span> 
