...
const Jury = () => {
  ...
  if (error) return <div className="text-red-500 text-center py-20">Erreur: {error}</div>;
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-extrabold text-navy mb-4">
            ...
            <span className="text-primary">{t("jury.titleHighlight", "Festival")}</span>
          </h1>
            ...
            {juryMembers.map((member) => (
              ...
              >
                <div className={`w-24 h-24 rounded-full p-1 bg-gradient-to-tr from-primary to-accent shadow-lg group-hover:scale-110 transition-transform duration-300 ${
                   selectedMemberId === member.id ? 'ring-4 ring-orange-500 ring-offset-2 ring-offset-[#070819]' : ''
                }`}>
                  <img
                ...
                <span className={`mt-3 text-sm font-bold transition-colors ${
                  selectedMemberId === member.id ? 'text-orange-500' : 'text-navy group-hover:text-primary'
                }`}>
          ...
          {juryMembers.map((member) => {
            ...
            return (
              ...
              >
                ...
                <h3 className={`text-xl font-bold ${isSelected ? 'text-orange-600' : 'text-navy'}`}>
                  {member.first_name} {member.last_name !== '-' ? member.last_name : ''}
                </h3>
