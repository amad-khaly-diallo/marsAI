    ...
    <div className="w-full bg-slate-950 text-white h-full bg-gradient-to-b from-sky-dark to-sky-light py-12 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
         ...
         <br></br>
         <br></br>
          {/* Nouvelle partie : avatars circulaires en haut de l'écran */}
        <div className="flex flex-wrap justify-center gap-8 mb-16">
          {juryMembers.map((member) => (
            <div key={member.id} className="flex flex-col items-center group cursor-pointer">
              ...
              {/* Nom de l'arbitre sous la photo */}
        ...
        <div className="grid text-black  grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {juryMembers.map((member) => (
            <div key={member.id} className="bg-white border-x-blue-500/80 rounded-2xl p-6 shadow-glass hover:shadow-glow transition-all duration-300 transform hover:-translate-y-2 text-center">
