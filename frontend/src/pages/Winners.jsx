...
export default function Winners() {
  ...
  return (
    <div className="min-h-screen bg-brand-bg text-slate-200 font-sans pb-20 overflow-x-hidden flex flex-col">
      ...
      {/* --- CARROUSEL PRINCIPAL --- */}
      <div className="relative w-full max-w-5xl mx-auto h-[750px] md:h-[650px] flex items-center justify-center mt-8 perspective-1000">
      ...
      {/* --- CONTRÔLES MANUELS --- */}
      <div className="flex justify-center gap-4 mb-8 -mt-10 z-40">
        <button
          onClick={prevSlide}
      ...
      <section className="max-w-4xl mx-auto px-4 text-center z-40">
