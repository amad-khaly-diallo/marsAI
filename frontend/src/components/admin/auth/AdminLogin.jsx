  ...
  return (
    <div className="mx-auto flex max-w-md flex-col gap-4 px-4 py-12">
      <div className="space-y-2 text-center">
        ...
        <h1 className="text-2xl font-semibold text-slate-50">Connexion espace admin</h1>
        <p className="text-sm text-brand-muted">Connectez-vous avec un compte administrateur pour gérer le festival marsAI.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4 rounded-lg border border-brand-border/60 bg-brand-surface/80 p-4 shadow-soft-md">
        ...
        <FormField label="Mot de passe" type="password" value={password} onChange={(e) => setPassword(e.target.value)} required />
