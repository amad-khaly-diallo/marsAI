...
const JuryAvatar = ({ 
  ...
  if (isMobile) {
    return (
      ...
      >
        <div className={`w-14 h-14 rounded-full p-[2px] transition-all duration-300 ${
          isActive 
        ...
        <div className="flex flex-col items-center gap-1">
          ...
          <div className={`h-[3px] w-8 rounded-full transition-all duration-500 ${
            isActive 
  ...
  return (
    ...
    >
      <div className={`w-full h-full rounded-full p-[2px] transition-all duration-500 
